...
# Real-time dashboard for live encrypted traffic classification.
...
# 4. Visualize traffic distribution.
# 5. Show latest prediction.
# 6. Show early-exit statistics.
# """
...
# st.caption(
#     "Real-Time Classification of Encrypted Network Traffic"
# )
...
#             "Traffic": list(traffic.keys()),

#             "Flows": list(traffic.values())
...
#         st.info("Waiting for classified traffic...")
...
#             "Exit": list(exits.keys()),

#             "Count": list(exits.values())
...
#         st.info("No exit statistics available.")
# st.divider()
